    ...
    for ticker in TICKERS:
        ...
        for period in REPORT_TYPES:
            ...
            prompt = (
                ...
                "them as relative changes, not percentage-point changes. DATA ACCURACY: A negative change (e.g., -9.2%) in Margin, ROE, or Net Income strictly means profitability WORSENED or DECLINED."
                "Do not use the term 'YoY' since this "
